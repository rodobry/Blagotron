...
class Buyrole:
    ...
    async def buyrole(self, ctx, role: discord.Role=None):
        """Buy a role of your choice with your hard earned balance
        To buy a role with a space in it, use quotes"""
    ...
    @Checker.admin_or_permissions(administrator=True)
    ...
    async def add(self, ctx, role: discord.Role, price):
        ...
        To add a role with a space in it put it in quotes,\"Role name\""""
        server = ctx.message.server.id

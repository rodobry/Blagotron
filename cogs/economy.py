...
class Economy:
    ...
    async def register(self, ctx):
        ...
        try:
            ...
            await self.bot.say("{} You already have an account at the bank.".format(user.mention))
    ...
    async def balance(self, ctx, user : discord.Member=None):
        ...
        if not user:
            ...
            try:
                ...
                await self.bot.say("{} You don't have an account at the bank."
...
def setup(bot):
    ...
    check_folders()
    check_files()
    logger = logging.getLogger("blagotron.economy")
